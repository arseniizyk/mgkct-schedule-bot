...
/setgroup - для привязки группы, все описанные ниже команды могут выполняться с указанием группы: /group 228
/group - расписание группы, использует вашу если привязана
